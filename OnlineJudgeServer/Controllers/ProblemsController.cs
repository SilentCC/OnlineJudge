...
namespace OnlineJudgeServer.Controllers
{
    ...
    public class ProblemsController : Controller
    {
        ...
        public async Task<IActionResult> Create(
            [Bind("ProblemId,Id,Title,MemoryLimit,TimeLimit,Content,Note,ExampleInput,ExampleOutPut,PushlishId,CategoryId,PublishTime")]
            Problem problem)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id,
            [Bind("ProblemId,Id,Title,AcceptSubmit,TotalSubmit,MemoryLimit,TimeLimit,Content,Note,ExampleInput,ExampleOutPut,PushlishId,CategoryId,PublishTime")]
            Problem problem)
        {
            if (id != problem.Id)
            {
